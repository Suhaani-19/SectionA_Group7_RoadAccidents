...
| Role | Name | GitHub Username | Portfolio |
|---|---|---|---|
| Project Lead & Statistical Analysis | Keshav Rajput | `keshavrajput` | [🌐 Portfolio](https://dva-portfolio-sand.vercel.app/) |
| EDA & Analysis Lead | Hardik Maheshwari | `hardikgenone` | [🌐 Portfolio](https://hardikgenone.github.io/dva-portfolio/) |
| Visualization Lead | Arya Pandey | `arya-p-gh` | [🌐 Portfolio](https://arya-p-gh.github.io/DVA_PORTFOLIO/) |
| Data Lead | Suhaani Garg | `Suhaani-19` | [🌐 Portfolio](https://suhaani-19.github.io/Data_Analytics_Portfolio/) |
| ETL Lead | Sathvik Koriginja | `sathvik89` | [🌐 Portfolio](https://sathvik89.github.io/DVA_Portfollio/) |
| Driver Risk Analysis | Krishna Dave | `krishna-dave` | — |
| PPT & Quality Lead | Anushka Tyagi | `anu-ushka` | [🌐 Portfolio](https://anu-ushka.github.io/DataAnalytics_Portfolio/) |
...
| **Time Period Covered** | Not time-series; cross-sectional accident records |
| **Format** | CSV |
...
| `Time` / `Hour` | Time of accident; hour extracted as derived column | Temporal analysis, heatmap |
...
11. **Road surface conditions (wet vs dry) show limited independent effect on severity** when controlling for driver behavior and time of day.
12. **Automobiles and public transport vehicles are involved in the most accidents**, with lorries and heavy vehicles skewing toward higher severity outcomes.
...
|---|---|---|---|
| 1 | Inexperienced drivers (under 2 years) are highest-risk | Mandate graduated licensing with night and highway restrictions for drivers under 2 years experience | Estimated 15–20% reduction in serious injuries among new drivers |
| 2 | Evening hours (17:00–19:00) peak in accidents | Increase traffic enforcement and signal optimization during evening rush hours | Reduce peak-hour accident frequency by 10–15% |
...
4. **Analyze** — EDA performed in `notebooks/03_EDA.ipynb`; full statistical analysis (univariate, bivariate, KPIs) in `notebooks/04_statistical_analysis.ipynb`.
5. **Visualize** — Four interactive Tableau dashboards built and published on Tableau Public covering severity, driver risk, accident causes, and time patterns.
6. **Recommend** — Five data-backed business recommendations delivered targeting driver behavior, infrastructure, and enforcement.
...
**GitHub Repository**
- [x] Public repository created with the correct naming convention (`SectionA_Group7_RoadAccidents`)
...
- [x] Interactive filters included (Time Period, Area, Day of Week, Driver Attributes)
...
- [x] Key insights in decision language
- [x] Actionable recommendations with impact estimates
